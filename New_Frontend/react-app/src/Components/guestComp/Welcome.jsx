            ...
            <div className="welcome-page">
                ...
                <main className="welcome-main">
                    ...
                    <section id="app-info" className="app-info-section">
                        ...
                        <ul>
                            <li>🔍 <strong>Explore the Library:</strong> Our platform allows for easy book searches by
                                genre,
                                author, or title.
                            </li>
                            ...
                            <li>➕ <strong>Personalized Recommendations:</strong> Our smart algorithm suggests books
                                based on
